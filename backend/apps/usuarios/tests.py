...
class UsuarioAuthTest(APITestCase):
    ...
    def test_admin_can_create_user(self):
        ...
        login_response = self.client.post(self.login_url, self.login_payload, format='json')
        ...
        self.assertEqual(User.objects.count(), 2) # Confirma que 2 usuários existem (admin + novo)
