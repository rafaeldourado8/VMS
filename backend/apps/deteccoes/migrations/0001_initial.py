    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plate', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ...
                ('camera', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deteccoes', to='cameras.camera')),
            ],
            options={
