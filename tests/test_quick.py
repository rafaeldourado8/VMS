"""
TESTE RÁPIDO - Envia 1 detecção fake para testar o sistema
"""
import requests
from datetime import datetime

# Configurações
BACKEND_URL = "http://localhost:8000/api/deteccoes/ingest/"
...
print("=" * 60)
print("TESTE RÁPIDO DE DETECÇÃO")
print("=" * 60)
...
try:
    ...
    print(f"📤 Enviando detecção para: {BACKEND_URL}")
